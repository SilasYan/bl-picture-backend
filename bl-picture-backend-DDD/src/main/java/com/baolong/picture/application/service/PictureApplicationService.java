...
public interface PictureApplicationService {
	 ...
	 * @return 图片分页列表
	 */
	Page<Picture> getPictureListPage(Page<Picture> page, QueryWrapper<Picture> queryWrapper);
	 ...
	 * @return 图片指定字段的列表
	 */
	List<Object> getPictureAppointFieldList(QueryWrapper<Picture> queryWrapper);
	 ...
	 * @return 图片指定字段的列表
	 */
	List<Map<String, Object>> getPictureAppointFieldMaps(QueryWrapper<Picture> queryWrapper);
}
