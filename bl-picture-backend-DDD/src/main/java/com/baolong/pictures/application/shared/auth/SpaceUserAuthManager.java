...
import com.baolong.pictures.application.shared.auth.model.SpaceUserAuthConfig;
import com.baolong.pictures.application.shared.auth.model.SpaceUserRole;
...
public class SpaceUserAuthManager {
	...
	public List<String> getPermissionList(Space space, User loginUser) {
		...
		// 管理员权限
		List<String> ADMIN_PERMISSIONS = getPermissionsByRole(SpaceRoleEnum.CREATOR.getKey());
		// 公共图库
		if (space == null) {
		...
		switch (spaceTypeEnum) {
			...
			case TEAM:
				...
				// TODO 修改 TeSpaceUser teSpaceUser = spaceUserApplicationService.getSpaceUser(queryWrapper);
				// if (teSpaceUser == null) {
				// 	return new ArrayList<>();
				// } else {
				// 	return getPermissionsByRole(teSpaceUser.getSpaceRole());
				// }
		}
		return new ArrayList<>();
	}
