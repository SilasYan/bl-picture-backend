...
public interface SpaceApplicationService {
	 ...
	 * @return 空间详情
	 */
	SpaceVO getSpaceVOById(Long spaceId);
	 ...
	 * @return 空间列表
	 */
	List<SpaceVO> getSpaceListAsUser(SpaceQueryRequest spaceQueryRequest);
	 ...
	 * @return 空间分页列表
	 */
	PageVO<Space> getSpacePageListAsAdmin(SpaceQueryRequest spaceQueryRequest);
